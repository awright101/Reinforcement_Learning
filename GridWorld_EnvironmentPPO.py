...
class AstroidGrid():
    ...
    def reset_env(self):
        ...
        environment[self.samar_pos[0],self.samar_pos[1]]=9
    ...
    def take_action(self,action):
        ...
        if self.environment[self.next_pos[0],self.next_pos[1]] == 3:
            self.samar_pos = self.next_pos
            reward = -1*np.random.randint(1,10)
            self.fuel_left += -1
        ...
        self.environment[self.samar_pos[0],self.samar_pos[1]]=9    
